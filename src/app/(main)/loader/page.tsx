...
export default function ZenoraLoader() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-yellow-600/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-48 h-48 mb-8">
          ...
          <svg className="absolute inset-0 w-full h-full" style={{ animation: 'spin 4s linear infinite reverse' }}>
            <circle
              cx="96"
              cy="96"
              r="76"
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="opacity-80">
              <path d="M6 7a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 0l6 6m0 0l6-6m-6 6l-6 6m6-6l6 6M6 23a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm12 0a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" 
                    stroke="#c79863" 
                    strokeWidth="1.5" 
                    strokeLinecap="round" 
        ...
        <div className="relative mb-6">
          <h1 className="text-5xl font-light tracking-[0.3em] text-white relative">
            {['Z', 'E', 'N', 'O', 'R', 'A'].map((letter, index) => (
              <span
                key={index}
        ...
        {/* Tagline */}
        <p className="text-amber-200/60 text-sm tracking-widest uppercase font-light mb-8 opacity-0" style={{ animation: 'fadeIn 1s ease-out 0.8s forwards' }}>
