...
const PriceBeautyPleasureSection: React.FC<BeautyPleasureSectionProps> = ({
  data,
  img
}) => {
              ...
              className={`space-y-4 sm:space-y-6 mb-8 sm:mb-10 transition-all duration-1000 delay-600 ₹
{
            ...
            >
              <p className="text-gray-300 text-base sm:text-lg lg:text-xl leading-relaxed">
                From precision cuts and beard sculpting to revitalizing scalp
                treatments and classic hot-towel shaves, we deliver refined
                grooming experiences designed for today’s men and women.
              </p>
              ...
              <p className="text-gray-400 text-sm sm:text-base lg:text-lg leading-relaxed">
                ...
                experiences tailored for today’s men and women.
              </p>
            </div>
...
export default PriceBeautyPleasureSection;
