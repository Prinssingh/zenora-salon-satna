...
const FemaleHairSalonShowcase: React.FC<HairSalonShowcaseProps> = ({
  data,
  title,
  des,
  des1,
  ...
  return (
    <section className="min-h-screen bg-linear-to-br from-gray-50 via-white to-amber-50/80 py-16 sm:px-2  lg:px-8 overflow-hidden">
      <div>
        {/* Section Header */}
...
export default FemaleHairSalonShowcase;
