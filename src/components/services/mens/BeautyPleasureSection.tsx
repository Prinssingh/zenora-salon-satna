...
const BeautyPleasureSection: React.FC<BeautyPleasureSectionProps> = ({
  data,
  img
}) => {
    ...
    >
      <div className="grid lg:grid-cols-2   h-full">
        ...
        <div className="relative  overflow-hidden group">
          ...
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-black/20 to-black/60 lg:to-black/80"></div>
            ...
            className={`absolute top-8 left-8 transition-all duration-1000 ₹
{
        ...
        {/* Right Side - Content */}
        <div className="relative bg-gradient-to-br from-zinc-800 via-neutral-900 to-stone-900 flex items-center">
                ...
                className={`text-3xl sm:text-4xl  lg:text-5xl xl:text-6xl font-bold leading-tight transition-all duration-1000 delay-200 ₹
{
              ...
              >
                {/* “Experience Confidence — Grooming Crafted for Him */}
                {/* Luxury Grooming for the Modern Gentleman */}
                <span className="block text-transparent mt-5 bg-clip-text bg-gradient-to-r from-golden via-golden to-amber-600">
                  Luxury Grooming
                </span>
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-golden via-golden to-amber-600 mt-2">
                  for the Modern
                </span>
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-golden via-golden to-amber-600 mt-2">
                  Gentleman
              ...
              <div
                className={`w-20 h-1 bg-gradient-to-r from-golden to-transparent transition-all duration-1000 delay-400 ₹
{
                  isVisible
              ...
              className={`space-y-4 sm:space-y-6 mb-8 sm:mb-10 transition-all duration-1000 delay-600 ₹
{
            ...
            >
              <p className="text-gray-300 text-base sm:text-lg lg:text-xl leading-relaxed">
                From precision haircuts and beard sculpting to revitalizing scalp
                treatments and classic hot-towel shaves, we deliver refined
                grooming experiences designed for the modern gentleman.
              </p>

              <p className="text-gray-400 text-sm sm:text-base lg:text-lg leading-relaxed">
                From sharp cuts to beard sculpting, we deliver premium grooming
                experiences tailored for the modern gentleman.
              </p>
            </div>
...
export default BeautyPleasureSection;
