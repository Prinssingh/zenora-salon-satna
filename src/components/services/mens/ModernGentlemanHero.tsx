...
const ModernGentlemanHero: React.FC<{ hero: string }> = ({ hero }) => {
                  ...
                  className={`text-lg sm:text-xl text-gray-300 leading-relaxed max-w-xl transition-all duration-1000 delay-400 ₹
{
                ...
                >
                 From classic cuts to modern styles, Zenora specializes in grooming services crafted exclusively for men who demand excellence.
                </p>
              </div>
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-golden/20 rounded-3xl p-8 space-y-8">
                  ...
                  <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed mb-4">
                      "The attention to detail and professionalism at Zenora is
                      unmatched. This is where modern men come for the ultimate
                      grooming experience."
                    </p>
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        icon: Scissors,
                        text: "Signature Haircuts",
                        price: "₹100+",
                      },
                      { icon: Star, text: "Beard Grooming", price: "₹59+" },
                      {
                        icon: Sparkles,
                        text: "BODY D-TAN",
                        price: "₹1999+",
...
export default ModernGentlemanHero;
