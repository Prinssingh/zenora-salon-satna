      ...
      <div className="container mx-auto px-4 sm:px-4 md:px-8 py-20 ">
        ...
        <div className="space-y-3 mb-5">
          ...
          <h1 className="text-3xl text-center sm:text-4xl md:text-5xl  font-black uppercase leading-tight">
            Men’s Grooming
            <br />
            <span className="text-golden"> Packages & Pricing</span>
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative  w-full lg:max-w-5xl max-w-xl mx-auto lg:mx-0">
            ...
            {/* Decorative elements */}
            <div className=" hidden md:block absolute -bottom-4 -left-4 w-20 sm:w-28 md:w-32 h-20 sm:h-28 md:h-32 bg-golden opacity-20 blur-3xl rounded-full"></div>
            <div className="hidden md:block absolute -top-4 -right-4 w-20 sm:w-28 md:w-32 h-20 sm:h-28 md:h-32 bg-golden opacity-20 blur-3xl rounded-full"></div>
          </div>
